package ProductTable;
	...
	class ProductLoader{
	    ...
	    public static void loadProduct() throws Exception {
	        ...
	        BufferedReader bf = new BufferedReader(new FileReader(new File("C:\\Users\\ravi.ranjan2\\eclipse-workspace\\Happiestminds\\Filehandling\\src\\ProductTable\\product")));
